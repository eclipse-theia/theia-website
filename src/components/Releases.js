        ...
        <header className='header' role="banner">
            <div className="row">
                ...
                <div className="header__text-box">
                    ...
                    <p>Eclipse Theia follows a monthly release cycle. You can find all releases including change logs and breaking changes <a href="https://github.com/eclipse-theia/theia/releases">here</a></p>
                    <br></br>
