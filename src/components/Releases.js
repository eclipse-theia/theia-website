...
const communityReleases = [
    ...
    {
        name: 'Theia 1.68.x (2026-02) - published',
        releasedate: 'February 26th, 2026',
        ...
        frameworks: [
            ...
            },
            {
                ...
                version: '0.8.4',
                modules: [
                    { modulename: '@eclipse-emfcloud/jsonforms-property-view', url: 'https://www.npmjs.com/package/@eclipse-emfcloud/jsonforms-property-view/v/0.8.4' }
                ]
            },
            {
                title: 'Eclipse Sprotty',
    ...
    {
        name: 'Theia 1.66.x (2025-11) - published',
        releasedate: 'November 27th, 2025',
        releasecandidatedate: 'October 30th, 2025',
        technologiesin: 'December 4th, 2025',
        releaseanouncement: 'December 11th, 2025',
        announcementurl: 'https://eclipsesource.com/blogs/2025/12/11/the-eclipse-theia-community-release-2025-11/',
        frameworks: [
            {
                title: 'Eclipse GLSP',
                url: 'https://www.eclipse.dev/glsp/',
                version: '2.5.0',
                modules: [
                    { modulename: '@eclipse-glsp/theia-integration', url: 'https://www.npmjs.com/package/@eclipse-glsp/theia-integration/v/2.5.0' }
                ]
            },
            {
                title: 'Eclipse EMF cloud',
                ...
                version: '0.8.3',
                modules: [
                    { modulename: '@eclipse-emfcloud/jsonforms-property-view', url: 'https://www.npmjs.com/package/@eclipse-emfcloud/jsonforms-property-view/v/0.8.3' }
                ]
            },
            {
                title: 'Eclipse Sprotty',
            ...
            },
            {
                ...
                version: '2.5.0',
                modules: [
                    { modulename: 'cdt-gdb-vscode', url: 'https://open-vsx.org/extension/eclipse-cdt/cdt-gdb-vscode/2.5.0' },
                    { modulename: 'cdt-gdb-adapter', url: 'https://www.npmjs.com/package/cdt-gdb-adapter/v/1.5.0' }
                ]
            },
            {
                title: 'Langium',
    ...
    {
        name: 'Theia 1.64.x (2025-08) - published',
...
const monthlyReleases = [
    {
        title: 'Eclipse Theia 1.73 Release: News and Noteworthy',
        url: 'https://eclipsesource.com/blogs/2026/07/07/eclipse-theia-1-73-release-news-and-noteworthy/',
    },
    {
        title: 'Eclipse Theia 1.72 Release: News and Noteworthy',
        url: 'https://eclipsesource.com/blogs/2026/06/15/eclipse-theia-1-72-release-news-and-noteworthy/',
    },
    {
        title: 'Eclipse Theia 1.71 Release: News and Noteworthy',
        url: 'https://eclipsesource.com/blogs/2026/05/21/eclipse-theia-1-71-release-news-and-noteworthy/',
    },
    {
        title: 'Eclipse Theia 1.70 Release: News and Noteworthy',
        url: 'https://eclipsesource.com/blogs/2026/04/16/eclipse-theia-1-70-release-news-and-noteworthy/',
    },
    {
        title: 'Eclipse Theia 1.69 Release: News and Noteworthy',
        url: 'https://eclipsesource.com/blogs/2026/03/10/eclipse-theia-1-69-release-news-and-noteworthy/',
    },
    {
        title: 'Eclipse Theia 1.68 Release: News and Noteworthy',
        url: 'https://eclipsesource.com/blogs/2026/02/12/eclipse-theia-1-68-release-news-and-noteworthy/',
    },
    {
        title: 'Eclipse Theia 1.67 Release: News and Noteworthy',
        url: 'https://eclipsesource.com/blogs/2025/12/18/eclipse-theia-1-67-release-news-and-noteworthy/',
    },
    {
        title: 'Eclipse Theia 1.66 Release: News and Noteworthy',
        url: 'https://eclipsesource.com/blogs/2025/11/13/eclipse-theia-1-66-release-news-and-noteworthy/',
    },
    {
        title: 'Eclipse Theia 1.65 Release: News and Noteworthy',
        url: 'https://eclipsesource.com/blogs/2025/10/16/eclipse-theia-1-65-release-news-and-noteworthy/',
    },
    {
