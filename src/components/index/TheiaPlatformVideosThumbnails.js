...
const TheiaPlatformVideosThumbnails = () => {
    const [activeVideo, setActiveVideo] = useState(null);

    // Filter videos by theia-platform tag
    const theiaPlatformVideos = youtubeVideos.filter(video =>
        video.tags && video.tags.includes('theia-platform')
    );
        ...
        <div className="row">
            <Styled>
                <section className="youtube-gallery">
                    <h3 className="heading-tertiary">Latest Theia Platform Videos</h3>
                    ...
                    <div className="youtube-gallery__container">
                        ...
                        >
                            {theiaPlatformVideos.map((video, i) => (
                                <SwiperSlide key={i}>
                                    <YoutubeCard>
                                        <div
...
export default TheiaPlatformVideosThumbnails
