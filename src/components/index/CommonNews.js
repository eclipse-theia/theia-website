...
const PlatformHeader = () => (
    <div className="header__banner">
        <h2 style={{ fontSize: '2.1rem' }}>
            <a href="https://eclipsesource.com/blogs/2026/09/10/eclipse-theia-1-75-release-news-and-noteworthy/" rel="noopener noreferrer">Learn about the latest 1.75 Release</a> and <a href="https://eclipsesource.com/blogs/2026/06/19/the-eclipse-theia-community-release-2026-05/">the latest Community Release (2026-05)</a>.
            <br />
