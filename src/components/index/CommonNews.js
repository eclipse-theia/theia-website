...
const PlatformHeader = () => (
    <div className="header__banner">
        <h2 style={{ fontSize: '2.1rem' }}>
            <a href="https://eclipsesource.com/blogs/2025/04/10/eclipse-theia-1-60-release-news-and-noteworthy/" rel="noopener noreferrer">Learn about the latest 1.60 Release</a> and <a href="https://eclipsesource.com/blogs/2025/03/19/the-eclipse-theia-community-release-2025-02/">the latest Community Release (2025-02)</a>.
            <br />
