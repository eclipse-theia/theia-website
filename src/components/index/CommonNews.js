...
const PlatformHeader = () => (
    <div className="header__banner">
        <h2 style={{ fontSize: '2.1rem' }}>
            <a href="https://eclipsesource.com/blogs/2026/06/15/eclipse-theia-1-72-release-news-and-noteworthy/" rel="noopener noreferrer">Learn about the latest 1.72 Release</a> and <a href="https://eclipsesource.com/blogs/2026/03/26/the-eclipse-theia-community-release-2026-02/">the latest Community Release (2026-02)</a>.
            <br />
