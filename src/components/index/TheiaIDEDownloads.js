    ...
    <StyledHeader>
            <div id="theiaidedownload" className="row">
                ...
                <div className="header__buttons">
                 ...
                 <div style="background-color: #ffe0e0; border: 2px solid #ff0000; padding: 15px; margin: 20px auto; max-width: 90%; border-radius: 5px;">
                    <strong>⚠️ Important Notice for Linux Users (1.63 Release):</strong><br />
                    If the latest 1.63 release does not start on your machine, use this parameter: <code style="background: #f0f0f0; padding: 3px 6px; border-radius: 3px;">./TheiaIDE.AppImage --gtk-version=3</code><br />
