    ...
    <StyledHeader>
        <header className='header' role="banner">
            <div className="row">
                ...
                <div className="header__banner">
                    <h2 style={{ fontSize: '2.1rem' }}>
                        <a href="https://eclipsesource.com/blogs/2024/10/09/eclipse-theia-1-54-release-news-and-noteworthy/" rel="noopener noreferrer">Learn about the latest 1.54 Release</a> and <a href="https://eclipsesource.com/blogs/2024/09/12/the-eclipse-theia-community-release-2024-08/">the latest Community Release (2024-08)</a>.
                        <br/>
