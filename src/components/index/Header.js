    ...
    <StyledHeader>
        <header className='header' role="banner">
            <div className="row">
                ...
                <div className="header__banner">
                    <h2 style={{ fontSize: '2.1rem' }}>
                        <a href="https://eclipsesource.com/blogs/2024/08/06/eclipse-theia-1-52-release-news-and-noteworthy/" rel="noopener noreferrer">Learn about the latest 1.52 Release</a> and <a href="https://eclipsesource.com/blogs/2024/06/20/the-eclipse-theia-community-release-2024-05/">the latest Community Release (2024-05)</a>.
                        <br/>
